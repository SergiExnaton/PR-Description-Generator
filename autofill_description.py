...
def write_description_as_comment(
    comments_url, authorization_header, generated_pr_description
):
...
def check_if_description_has_already_been_autogenerated(comments_url, authorization_header, autogenerated_title):
...
def main():
    ...
    print(f"Pull request data: {pull_request_data}")
    check_pull_request_author_is_allowed_to_trigger_action(
        pull_request_data, allowed_users
    )
    check_if_description_has_already_been_autogenerated(comments_url, authorization_header, autogenerated_title)
    ...
    write_description_as_comment(github_api_url, repo, pull_request_id, authorization_header, autogenerated_title, authorization_header, generated_pr_description)
