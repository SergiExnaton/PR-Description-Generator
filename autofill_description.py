...
def write_description_as_comment(
    ...
    if add_comment_result.status_code != requests.codes.created:
        raise ValueError(
            ...
            + str(add_comment_result.status_code) + "Response: " + add_comment_result.text
        )
...
def main():
    ...
    if check_if_description_has_already_been_autogenerated(comments_url, authorization_header, autogenerated_title) == 0:
        return 0
    ...
    write_description_as_comment(comments_url, authorization_header, generated_pr_description)
